...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Designer blending gov UX, gamer focus & a bit of anime energy
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             I'm a visual & product designer from Bangalore. Right now at the Centre for e-Governance, I turn dense government workflows into quieter, clearer interfaces that everyday people can move through without feeling like they're fighting a boss battle.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "I treat every project like a boss raid: study, strategize, strike."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1oE25PRIRMWEUSM7JNEFBBrVO9WfX9Wn5/view?usp=drive_link" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
